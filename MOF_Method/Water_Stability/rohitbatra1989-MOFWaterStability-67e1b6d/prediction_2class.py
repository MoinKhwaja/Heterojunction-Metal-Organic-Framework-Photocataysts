...
#dataset = 'predict'
dataset = 'validation'
all_fp = pd.read_csv('MOF_Method/Water Stability/rohitbatra1989-MOFWaterStability-67e1b6d/data/validationdata.csv')
...
model_2class = pickle.load( open("MOF_Method/Water Stability/rohitbatra1989-MOFWaterStability-67e1b6d/models/rf_ml_2class.pkl", "rb" ) )
